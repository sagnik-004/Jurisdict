...
const Sidebar = ({
  ...
  return (
    <div
      className={`fixed top-0 left-0 h-screen bg-gray-900 text-white flex flex-col justify-between shadow-lg transition-transform duration-300 z-50 ${
        isSidebarVisible
          ? "translate-x-0 w-72 p-6"
          : "-translate-x-full w-72 p-6"
      }`}
    >
      <div>
