  ...
  const handleAskAI = async (caseId, groundsOfBail, caseSummary) => {
    ...
    try {
      const response = await fetch(
        "https://jurisdict-8nns.onrender.com/process_case_detainee",
        {
          method: "POST",
          headers: {
  ...
  return (
    ...
    >
      ...
      >
        ...
        <Tab
          label={`Pending to Lawyer (${bailCases.pendingToLawyer.length})`}
        />
      </Tabs>
                    ...
                    <Collapse in={expandedCaseId === caseItem._id}>
                      ...
                      >
                        ...
                        <Typography
                          ...
                          style={{ color: themeColors.cardText }}
                        >
                          <strong>Detainee Name:</strong>{" "}
                          {caseItem.detaineeName}
                        </Typography>
                        <Typography
                          variant="body2"
                          style={{ color: themeColors.cardText }}
                        >
                          <strong>Grounds of Bail:</strong>{" "}
                          {caseItem.groundsOfBail}
                        </Typography>
                        <Typography
                          variant="body2"
                          style={{ color: themeColors.cardText }}
